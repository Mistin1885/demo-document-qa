...
# ---------------------------------------------------------------------------
# GET /chats/{chat_id}/sessions — list + isolation
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# GET /chats/{chat_id}/sessions/{session_id} — get + cross-chat isolation
# ---------------------------------------------------------------------------
...
async def test_get_session_cross_chat_returns_404(
    ...
    Core isolation test: Chat A must not learn about a session that belongs
    to Chat B — the response must be 404, not a different chat's data.
    """
